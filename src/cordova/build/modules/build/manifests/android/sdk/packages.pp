class build::android::sdk::packages {
  ...
  package {[
    ...
    before => Bash_exec['( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | /usr/local/src/android-sdk-linux/tools/android update sdk --no-ui -a --filter platform-tool,build-tools-22.0.1,android-22']
  }
  ...
  bash_exec { '( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | /usr/local/src/android-sdk-linux/tools/android update sdk --no-ui -a --filter platform-tool,build-tools-22.0.1,android-22':
